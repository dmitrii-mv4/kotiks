...
@endif
        ...
        <div class="bg-header-dark">
          <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="{{ route('admin.dashboard') }}">
              ...
              <span class="smini-hidden">Kotiks CMS</span>
            </a>
            <!-- END Logo -->
            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                <a href="#" class="nav-main-link">
                  ...
                  <span class="nav-main-link-name">Страницы сайта</span>
                </a>
              </li>
              ...
              <li class="nav-main-item">
                ...
                <li class="nav-main-item">
                  ...
                  <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                      <a href="{{ route('admin.dashboard') }}" class="nav-main-link">
                        <span class="nav-main-link-name">Общие</span>
                      </a>
                    </li>
                  </ul>
                </li>
    ...
    <!-- Page JS Plugins -->
    <script src="/assets/admin/js/plugins/chart.js/chart.umd.js"></script>

    <!-- Page JS Code -->
    <script src="/assets/admin/js/pages/be_pages_dashboard.min.js"></script>
</body>
</html>
